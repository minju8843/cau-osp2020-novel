...
쥐는 자신을 따라오라며 자신 있게 손짓하더니, 톰과 제리가 노을 세계에 처음 왔을 때처럼 잭과 제리를 이정표 앞으로 안내했다.

```
이 길로 갔다간 톰이 이미 검은 마녀에게 당한 다음에 도착하고 말 거예요...!
다른 길은 없어요?
```

제리는 톰과 쉬운 길을 선택했을 때, 몇 시간을 걸어도 아무것도 나오지 않았던 것을 떠올렸다. 톰에게 무슨 일이 생길지도 모르는 지금, 제리는 하루빨리 없는 지름길이라도 만들어내서 톰을 찾아야만 했다.
...
쥐는 다 알고 있다는 듯, 빙긋 웃으며 '어려운 길'이라고 쓰여있는 방향으로 향했다.

왠지 쉬운 길보다 험난한 여정이 예상되었지만 잭과 제리는 노을 세계의 지리에 잘 알지못하기에, 마지못해 쥐를 따라갔다. 그리고 예상대로 그들은 얼마 가지 않아 수상한 분위기를 풍기는 동굴 속으로 들어갔다. 

동굴 속으로 들어가자마자 그들을 반긴 것은 다름 아닌 끝이 보이지 않는 낭떠러지였다. 그렇다고 해서 길이 아예 없는 것은 아니었다. 저 멀리 잭과 제리의 눈앞에 보이는 다음 동굴에 들어가기 위해선 듬성듬성 솟아올라와 있는 돌기둥들을 밟고 가야만 했다.
